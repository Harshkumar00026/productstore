...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('name', 'price', 'brand', 'category', 'image_preview')  # Added 'category' and 'image_preview'
    list_filter = ('brand',  'category')  # Updated list_filter to include 'category'
    search_fields = ('name', 'description',  'category')  # Updated search_fields to include 'category'
